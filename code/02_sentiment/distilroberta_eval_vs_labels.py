...
while True:
    cursor.execute("SELECT body FROM my_existing_table LIMIT ? OFFSET ?", (page_size, offset))
...
for row in annotated_data:
    ...
    try:
        ...
        # 打印预测结果
        print(f"Title: {title}, True Label: {true_label}, Predicted Label: {predicted_label}")
    except Exception as e:
